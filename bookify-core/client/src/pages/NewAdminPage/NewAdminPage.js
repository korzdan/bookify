...
const NewAdminPage = () => {
    ...
    const handleRegistration = () => {
        setError(null);
        axios.post("http://localhost:8081/auth/register/admin", {
            name: name,
            surname: surname,
            email: email,
            password: password
    ...
    return (
        <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-5 lg:px-8 mt-10">
            ...
            <div className="mt-5 sm:mx-auto sm:w-full sm:max-w-sm">
                ...
                <form className="space-y-6">
                    ...
                    <div
                        ...
                        <input type="button" id="login" value="Зарегистровать" onClick={handleRegistration}/>
                    </div>
                </form>
            </div>
        </div>
