TRUNCATE genre, book, user_account, statistics CASCADE;
...
insert into book(title, description, publication_date, genre_id, pages, isbn, language, author, publisher, storage_num, price)
values ('Великий Гэтсби',
...
insert into user_account(email, password, is_enabled, role, orders_num, name, surname)
values ('user', '$2a$10$Q2pV/IZs9XhYKh8ZeMKKTOjisu6kxMTA6zFL.hTYvJujWOCTYF9Sq', true, 'ROLE_USER', 0, 'User', 'User'),
       ('admin', '$2a$16$0SjsnuqtGQHIaVISve16uuSmPzialzMFl3S3Z/mQepGKWOy0yQCpW', true, 'ROLE_ADMIN', 0, 'Admin', 'Admin'),
       ('super-admin', '$2a$16$qPFbOORoMHBmIn.2MiSPkOV1gBawphvmGKLtA/BCFXtuMbObFGZhS', true, 'ROLE_SUPER_ADMIN', 0, 'Super-admin', 'Super-admin');

insert into statistics(users_num, orders_num, books_num)
values (3, 0, 6);